...
TOOL_SYSTEM_PROMPT: str = (
    ...
    "\n"
    "CRITICAL RULES:\n"
    "- You CANNOT do math in your head. ALL arithmetic MUST use the calculator tool.\n"
    "- NEVER write <<...>> expressions. They are forbidden.\n"
    "- NEVER write a numeric result that was not produced by a tool call.\n"
    "- When you call a tool, do NOT write the answer in the same <think> block.\n"
    "  Call the tool and STOP. Wait for the <tools> result, then answer in the next <think>.\n"
    "- The ONLY way to produce a number is via @ID reference to a tool output.\n"
    "\n"
    "TOOL USAGE RULES:\n"
    "Tools may be invoked ONLY inside the <think>...</think> section.\n"
    "Tools are NEVER allowed inside the <answer> section.\n"
    ...
    "\n"
    "Second response:\n"
    "<think>The API says 97 kcal per 100g. A medium banana is about 120g. "
    'I need to compute calories for 3 bananas: @calculator(expression="97 * 1.2 * 3")->2.</think>\n'
    "\n"
    "System tool execution:\n"
    "<tools>\n"
    "{\n"
    ...
    "\n"
    "Third response:\n"
    "<think>The calculator says 349.2 kcal for 3 medium bananas.</think>\n"
    ...
    "\n"
    "First response:\n"
    '<think>Sugar per 100g is 15.8g. For 250g I need to calculate: @calculator(expression="15.8 * 250 / 100")->1.</think>\n'
    "\n"
    "System tool execution:\n"
    "<tools>\n"
    "{\n"
    ...
    "\n"
    "Second response:\n"
    "<think>The calculator returned 39.5.</think>\n"
    ...
    "        successful_execution: True,\n"
    "        args: {'query': 'banana bread recipe'},\n"
    "        output: 'Mix 3 ripe bananas, 1 cup sugar, 1 egg, ...'\n"
    "    }\n"
    "}\n"
    "</tools>\n"
    "\n"
    "Second response:\n"
    "<think>I found the recipe from the knowledge base.</think>\n"
    "<answer>@1</answer>\n"
)
